...
/**
 * JavaMail 版本: 1.6.0(在本测试中必须使用1.6.0的，使用1.6.1会有部分邮箱收不到)
...
public class Main2 {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "啊啊啊", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "干啥呢", "UTF-8"));
